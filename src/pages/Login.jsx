  ...
  return (
    <div className="min-h-screen flex items-center justify-center relative p-4">
      ...
      >
        ...
        <h2 className="font-display text-xl font-bold text-center dark:text-white mb-1">Welcome back</h2>
        <p className="text-sm text-center text-gray-500 dark:text-gray-400 mb-6">Log in to your account</p>
        ...
        <p className="text-sm text-center text-gray-500 dark:text-gray-400 mt-6">
          ...
          <Link to="/signup" className="text-purple-500 font-medium hover:text-purple-600">Sign up</Link>
        </p>
      </motion.div>
    </div>
  );
